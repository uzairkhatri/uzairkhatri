...
const nodeDescriptions: Record<string, string> = {
  ...
  "w-cache": "Redis in-memory caching layer serving pre-compiled audit audits directly to API gateways.",
  ...
  "sv-ledger": "ACID double-entry ledger validating balance balances before ledger commits.",
...
export default function ProjectVisual({ type, variant = "card", activeLogIndex = 7 }: ProjectVisualProps) {
  ...
  const WellowsDiagram = () => (
    <svg className={styles.svgDiagram} viewBox="0 0 760 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M 290 120 L 330 55" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-wellows)" />
      <path d="M 290 130 L 330 130" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-wellows)" />
      <path d="M 290 140 L 330 205" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-wellows)" />
      ...
      <g className={nodeClass("w-ingest")} onMouseEnter={() => setHoveredNode("w-ingest")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-guard")} onMouseEnter={() => setHoveredNode("w-guard")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-router")} onMouseEnter={() => setHoveredNode("w-router")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-kiva")} onMouseEnter={() => setHoveredNode("w-kiva")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-opta")} onMouseEnter={() => setHoveredNode("w-opta")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-citation")} onMouseEnter={() => setHoveredNode("w-citation")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-vector")} onMouseEnter={() => setHoveredNode("w-vector")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-llm")} onMouseEnter={() => setHoveredNode("w-llm")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-fallback")} onMouseEnter={() => setHoveredNode("w-fallback")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-judge")} onMouseEnter={() => setHoveredNode("w-judge")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-telemetry")} onMouseEnter={() => setHoveredNode("w-telemetry")} onMouseLeave={() => setHoveredNode(null)}>
      ...
      <g className={nodeClass("w-cache")} onMouseEnter={() => setHoveredNode("w-cache")} onMouseLeave={() => setHoveredNode(null)}>
  ...
  const ClassFlowDiagram = () => (
    <svg className={styles.svgDiagram} viewBox="0 0 760 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M 290 120 L 330 55" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-classflow)" />
      <path d="M 290 130 L 330 130" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-classflow)" />
      <path d="M 290 140 L 330 205" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-classflow)" />
      ...
      {/* Nodes */}
      <g className={nodeClass("cf-event")} onMouseEnter={() => setHoveredNode("cf-event")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-lock")} onMouseEnter={() => setHoveredNode("cf-lock")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-state")} onMouseEnter={() => setHoveredNode("cf-state")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-timezone")} onMouseEnter={() => setHoveredNode("cf-timezone")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-load")} onMouseEnter={() => setHoveredNode("cf-load")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-celery")} onMouseEnter={() => setHoveredNode("cf-celery")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="190" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-postgres")} onMouseEnter={() => setHoveredNode("cf-postgres")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="30" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-ledger")} onMouseEnter={() => setHoveredNode("cf-ledger")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-stripe")} onMouseEnter={() => setHoveredNode("cf-stripe")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="190" width="120" height="40" rx="6" />
        <text x="540" y="208" className={styles.nodeTitle}>Stripe Custom</text>
        <text x="540" y="220" className={styles.nodeSub}>Payout Api</text>
      </g>

      <g className={nodeClass("cf-release")} onMouseEnter={() => setHoveredNode("cf-release")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="210" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("cf-broadcast")} onMouseEnter={() => setHoveredNode("cf-broadcast")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="630" y="110" width="110" height="40" rx="6" />
  ...
  const SavyourDiagram = () => (
    <svg className={styles.svgDiagram} viewBox="0 0 760 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M 290 120 L 330 55" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-savyour)" />
      <path d="M 290 130 L 330 130" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-savyour)" />
      <path d="M 290 140 L 330 205" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-savyour)" />
      ...
      {/* Nodes */}
      <g className={nodeClass("sv-webhook")} onMouseEnter={() => setHoveredNode("sv-webhook")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-limiter")} onMouseEnter={() => setHoveredNode("sv-limiter")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-router")} onMouseEnter={() => setHoveredNode("sv-router")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-bloom")} onMouseEnter={() => setHoveredNode("sv-bloom")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-calc")} onMouseEnter={() => setHoveredNode("sv-calc")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-sqs")} onMouseEnter={() => setHoveredNode("sv-sqs")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="190" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-evict")} onMouseEnter={() => setHoveredNode("sv-evict")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="30" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-postgres")} onMouseEnter={() => setHoveredNode("sv-postgres")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-ledger")} onMouseEnter={() => setHoveredNode("sv-ledger")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="190" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-sync")} onMouseEnter={() => setHoveredNode("sv-sync")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="210" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("sv-settle")} onMouseEnter={() => setHoveredNode("sv-settle")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="630" y="110" width="110" height="40" rx="6" />
  ...
  const EFULifeDiagram = () => (
    <svg className={styles.svgDiagram} viewBox="0 0 760 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M 290 120 L 330 55" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-efu)" />
      <path d="M 290 130 L 330 130" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-efu)" />
      <path d="M 290 140 L 330 205" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1.2" markerEnd="url(#arrow-efu)" />
      ...
      {/* Nodes */}
      <g className={nodeClass("ef-scanner")} onMouseEnter={() => setHoveredNode("ef-scanner")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-datacap")} onMouseEnter={() => setHoveredNode("ef-datacap")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="20" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-router")} onMouseEnter={() => setHoveredNode("ef-router")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-ldap")} onMouseEnter={() => setHoveredNode("ef-ldap")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="30" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-dispatch")} onMouseEnter={() => setHoveredNode("ef-dispatch")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="110" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-metadata")} onMouseEnter={() => setHoveredNode("ef-metadata")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="330" y="190" width="110" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-filenet")} onMouseEnter={() => setHoveredNode("ef-filenet")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="30" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-postgres")} onMouseEnter={() => setHoveredNode("ef-postgres")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="110" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-audit")} onMouseEnter={() => setHoveredNode("ef-audit")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="480" y="190" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-ldap-verify")} onMouseEnter={() => setHoveredNode("ef-ldap-verify")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="170" y="210" width="120" height="40" rx="6" />
      ...
      <g className={nodeClass("ef-portal")} onMouseEnter={() => setHoveredNode("ef-portal")} onMouseLeave={() => setHoveredNode(null)}>
        <rect x="630" y="110" width="110" height="40" rx="6" />
